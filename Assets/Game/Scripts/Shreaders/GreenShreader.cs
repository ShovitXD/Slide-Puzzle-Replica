...
public class GreenShreader : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.CompareTag("Tile Green"))
        {
            Destroy(collision.gameObject);
            gameManager.Points++;
        }
        if (collision.gameObject.CompareTag("Tile Red") && gameManager.SwapAlloed == true)
        {
