...
public class BlueShreader : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.CompareTag("Tile Blue"))
        {
            Destroy(collision.gameObject);
            gameManager.Points++;
        }
        if (collision.gameObject.CompareTag("Tile Yellow") && gameManager.SwapAlloed == true)
        {
